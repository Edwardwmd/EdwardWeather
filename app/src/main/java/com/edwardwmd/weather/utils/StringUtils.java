...
public class StringUtils {
	  ...
	  public static String getString(@StringRes int id) {
		    try {
				return EdWeatherApp.getAppContext().getResources().getString(id);
	  ...
	  public static String getString(@StringRes int id, Object... formatArgs) {
		    try {
				return EdWeatherApp.getAppContext().getString(id, formatArgs);
		    } catch (Resources.NotFoundException ignore) {
				return "";
		    }
	  }
	  ...
	  public static String[] getStringArray(@ArrayRes int id) {
		    try {
				return EdWeatherApp.getAppContext().getResources().getStringArray(id);
		    } catch (Resources.NotFoundException ignore) {
				return new String[0];
		    }
	  }
	  ...
	  public static int getIntBeforeColon(String time) {
		    return Integer.parseInt(time.substring(0,time.indexOf(":")));
	  }


	  public static int getIntAfterColon(String time) {
