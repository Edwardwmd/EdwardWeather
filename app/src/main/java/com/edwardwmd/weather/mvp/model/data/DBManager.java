...
import static com.edwardwmd.weather.mvp.model.data.DBConfig.COLUMN_C_CODE;
import static com.edwardwmd.weather.mvp.model.data.DBConfig.COLUMN_C_NAME;
import static com.edwardwmd.weather.mvp.model.data.DBConfig.COLUMN_C_PINYIN;
import static com.edwardwmd.weather.mvp.model.data.DBConfig.COLUMN_C_PROVINCE;
import static com.edwardwmd.weather.mvp.model.data.DBConfig.DB_NAME_V1;
import static com.edwardwmd.weather.mvp.model.data.DBConfig.LATEST_DB_NAME;
import static com.edwardwmd.weather.mvp.model.data.DBConfig.TABLE_NAME;
...
public class DBManager {
    ...
    private void copyDBFile(){
        ...
        if (!dbFile.exists()){
            ...
            OutputStream os;
            try {
                is = mContext.getResources().openRawResource(R.raw.china_cities_v2);
